...
def _create_entry2(img, question, answer,objects):
    answer.pop('image_id')
    answer.pop('question_id')
    entry = {
        'question_id' : question['question_id'],
...
def _create_entry3(img, question, answer,question_type):
    answer.pop('image_id')
    answer.pop('question_id')
    entry = {
        'question_id' : question['question_id'],
...
def _create_entry4(img, question, answer,objects,question_type):
    answer.pop('image_id')
    answer.pop('question_id')
    entry = {
        'question_id' : question['question_id'],
...
def _load_dataset2(dataroot, name, img_id2val):
    ...
    for question, answer in zip(questions, answers):
        ...
        utils.assert_eq(question['image_id'], answer['image_id'])
        img_id = question['image_id']
        entries.append(_create_entry2(img_id2val[img_id], question, answer, objects[img_id]))
...
def _load_dataset3(dataroot, name, img_id2val,question_type):
    ...
    for question, answer in zip(questions, answers):
        ...
        utils.assert_eq(question['image_id'], answer['image_id'])
        img_id = question['image_id']
        entries.append(_create_entry3(img_id2val[img_id], question, answer, question_type))
...
def _load_dataset4(dataroot, name, img_id2val,question_type):
    ...
    for question, answer in zip(questions, answers):
        ...
        utils.assert_eq(question['image_id'], answer['image_id'])
        img_id = question['image_id']
        entries.append(_create_entry4(img_id2val[img_id], question, answer, objects[img_id],question_type))

    return entries


def _load_dataset_Relation(dataroot, name, img_id2val,question_type):
    """Load entries
...
class VQAFeatureDataset2(Dataset):
    def __init__(self, name, dictionary, dataroot='data'):
...
class VQAFeatureDataset3(Dataset):
    def __init__(self, name, dictionary, dataroot='data'):
        super(VQAFeatureDataset3, self).__init__()
        assert name in ['train', 'val', 'test']
...
class VQAFeatureDataset4(Dataset):
    def __init__(self, name, dictionary, dataroot=saved_data_path):
        ...
        self.label2ans = cPickle.load(open(label2ans_path, 'rb'))
        self.num_ans_candidates = len(self.ans2label)
        self.question_type = cPickle.load(open(os.path.join(dataroot,'total_question_type.pkl'),'rb'))
...
class VQAFeatureDataset_Relation(Dataset):
    def __init__(self, name, dictionary, dataroot=saved_data_path):
        super(VQAFeatureDataset_Relation, self).__init__()
        assert name in ['train', 'val', 'test']
        ...
        self.entries = _load_dataset_Relation(dataroot, name, self.img_id2idx,self.question_type)
